    ...
    DB.schema.dropTableIfExists(`${tableName}`).then(() => {
      DB.schema
        .createTable(`${tableName}`, function (table) {
          ...
          table.string('bannerImage1').defaultTo(`http://${process.env.HOST_NAME}/uploads/sample_banner.png`);
          table.string('bannerImage2').defaultTo(`http://${process.env.HOST_NAME}/uploads/sample_banner.png`);
          table.string('bannerImage3').defaultTo(`http://${process.env.HOST_NAME}/uploads/sample_banner.png`);
          table.string('bannerImage4').defaultTo(`http://${process.env.HOST_NAME}/uploads/sample_banner.png`);
          table.string('bannerImage5').defaultTo(`http://${process.env.HOST_NAME}/uploads/sample_banner.png`);
  ...
  let projectStatus = [
    {
      ...
      bannerImage1: `http://${process.env.HOST_NAME}/uploads/sample_banner.png`,
      bannerImage2: `http://${process.env.HOST_NAME}/uploads/sample_banner.png`,
      bannerImage3: `http://${process.env.HOST_NAME}/uploads/sample_banner.png`,
    },
  ];
  return new Promise(async (resolve, reject) => {
    DB(`${tableName}`)
